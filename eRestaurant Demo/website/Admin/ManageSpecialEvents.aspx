            ...
            <InsertItemTemplate>
                <div>
                    <asp:LinkButton runat="server" ID="InsertButton" CommandName="Insert">
                        Insert <span class="glyphicon plyphicon-plus"></span>
                    </asp:LinkButton>
                    &nbsp;&nbsp;
                    ...
                    <asp:Label ID="Label3" runat="server" CssClass="control-label" AssociatedControlID="EventCodeCheckBox">Event Code</asp:Label>
                    <asp:TextBox ID="EventCodeCheckBox" runat="server" Text='<%# Bind("EventCode") %>' />
                    &mdash;

                    <asp:Label ID="Label4" runat="server" CssClass="control-label" AssociatedControlID="DescriptionCheckBox">Description</asp:Label>
                    <asp:TextBox ID="DescriptionCheckBox" runat="server" Text='<%# Bind("Description") %>' />
                </div>
            </InsertItemTemplate>
